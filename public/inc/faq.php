...
<div class="box">
	...
	<ul id="faq">
		...
		<li>Yes! You can upload any image up to <span class="black"><?php $i = 0; while ($allowed_size >= 1000) { $allowed_size = ($allowed_size / 1000); ++$i; } $units = array('', 'K', 'M'); echo round($allowed_size, 1) . $units[$i]; ?>B</span> in size</li>
